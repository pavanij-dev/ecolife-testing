...
CURLOPT_POST => true,
CURLOPT_POSTFIELDS => [
'secret' => '6LeLFBwqAAAAAOVAuRzYvhWtjXV2FpPq4NfI1be0',
'response' => $_POST["token"],
...
//$mail->AddAddress('server@grank.co.in', 'Ecolife Developers');
...
$accessKey = 'u$ra60d318edcfd2c3f750e83fd62ce98ed';
$secretKey = '1b528235093484a37fbba7216c6aa08d33b6084a';
...
//echo $curl;
header("Location: thankyou-contact.php?email=$email&download=1");
